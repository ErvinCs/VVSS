...
public class SearchByKeywordStory {
    ...
    @Test
    public void searching_by_wood_keyword_should_display_the_disambiguation_page() {
        anna.is_the_home_page();
        anna.looks_for("wood");
        anna.should_see_definition("The substance making up the central part of the trunk and branches of a tree. Used as a material for construction, to manufacture various items, etc. or as fuel.");
    }
} 